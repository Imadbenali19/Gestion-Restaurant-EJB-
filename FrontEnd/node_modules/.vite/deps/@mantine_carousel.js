...
var CarouselSlide_styles_default = useStyles;
...
var CarouselSlide = (0, import_react2.forwardRef)((_a, ref) => {
  ...
  return import_react2.default.createElement(Box, __spreadValues2({
...
var useStyles2 = createStyles((theme, {
  ...
  return {
    ...
    container: __spreadValues3(__spreadValues3({
      display: "flex",
    ...
    control: __spreadProps(__spreadValues3({
      display: "flex",
...
var Carousel_styles_default = useStyles2;
...
var _Carousel = (0, import_react3.forwardRef)((props, ref) => {
  ...
  const { classes, cx, theme } = Carousel_styles_default({ controlSize, controlsOffset, orientation, height, includeGapInSize, breakpoints, slideGap }, { name: "Carousel", classNames, styles, unstyled });
